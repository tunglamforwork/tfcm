	...
	return (
		<section className='my-40 md:my-52' id='testimonials'>
			<div className='max-w-5xl mx-auto p-[1.25rem] pt-16 flex flex-col items-center'>
				...
				<p className='relative text-primary max-w-2xl text-center text-base md:text-xl mb-12 before:absolute before:left-1/2 before:top-0 before:-translate-x-1/2 before:w-[70%] before:rounded-full before:shadow-hero-secondary'>
					Join thousands of brands and content creators who use our
				...
				<div className='mt-6 md:mt-12 grid md:grid-cols-3 md:grid-rows-7 gap-10 w-full'>
					<div className='col-span-1 md:row-span-4 border border-border/50 bg-secondary/5 rounded-md p-4 flex flex-col gap-4'>
						...
						<p className='text-sm text-foreground'>
							...
							<span className='text-foreground'>TFCM</span> so
							far. <br />
							<br />
							It is just the right amount of simple/fast for a
							content generation app and does most of the hard
							work of copywriting.
						</p>
					</div>
					...
					<div className='col-span-1 md:row-span-4 border border-border/50 bg-secondary/5 rounded-md p-4 flex flex-col gap-4'>
						...
						<p className='text-sm text-foreground'>
							<span className='text-primary'>TFCM</span> is a
							critical step forward in the evolution of AI powered
							copywriting services; it provides wide range of
							powerful tools that makes my life as a content
							creator so much easier!
						</p>
					</div>
					<div className='col-span-1 md:row-span-4 border border-border/50 bg-secondary/5 rounded-md p-4 flex flex-col gap-4'>
						<div className='flex items-center gap-4'>
						...
						<p className='text-sm text-foreground'>
							Not only it has everything any content creator or
							small brand needs, it also has very cheap prices.
							<br />
							<br />
							<span className='text-tertiary'>GPT Writer</span> is
					...
					<div className='col-span-1 md:row-span-3 border border-border/50 bg-secondary/5 rounded-md p-4 flex flex-col gap-4'>
						...
						<p className='text-sm text-foreground'>
							I&apos;m in love with this copywriting tool. 🤩 It
							helps alot!
						</p>
					</div>
					<div className='col-span-1 md:row-span-3 border border-border/50 bg-secondary/5 rounded-md p-4 flex flex-col gap-4'>
						...
						<p className='text-sm text-foreground'>
							I think this tool is going to be a game changer for
							copywriting 😉
						</p>
					</div>
				</div>
