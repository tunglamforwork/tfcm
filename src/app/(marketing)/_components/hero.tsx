...
export const Hero = () => {
	return (
		<section className='relative before:absolute before:h-[400px] before:container before:left-1/2 before:-translate-x-1/2 before:pointer-events-none before:z-[1] before:bg-header-gradient before:-top-nav-height'>
			<div className='relative container pt-28 flex flex-col items-center'>
				<Button
					variant='secondary'
					size='sm'
				...
				<h1 className='mt-8 mb-6 font-heading text-5xl sm:text-7xl tracking-wide text-center animate-slide-down delay-200'>
					Tell A Better Story<span className='sm:hidden'>,</span>{' '}
					<br className='hidden md:block' />
					Grow Your Brand
				</h1>
				<p className='relative text-primary max-w-2xl text-center text-base md:text-xl mb-12 animate-slide-down delay-200 before:absolute before:left-1/2 before:top-0 before:-translate-x-1/2 before:w-[70%] before:rounded-full before:shadow-hero'>
					Generate ideas, improve your grammar, and optimize your
				...
				<Link
					...
					className={cn(
						...
						'animate-slide-down delay-500'
					)}
				>
					<span>Get Started</span>
					<Icons.chevronRight className='h-4 ml-1 -mr-2' />
				</Link>
				<div className='relative mt-16 md:mt-32 animate-slide-down delay-700 after:absolute after:inset-0 after:w-full after:h-full after:shadow-hero-image after:animate-pulse-slow'>
